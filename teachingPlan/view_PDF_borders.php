...
if ($_SERVER['REQUEST_METHOD'] == 'POST') {
    ...
    // Get the subject from the GET parameters (if available) does not work right now
    ...
    $html = '<h3 style="text-align:center;">References for ' . $subject . '</h3>';
    $html .= '<table cellspacing="0" cellpadding="4" style="width: 100%; border-collapse: collapse;">';
    ...
    $html .= '
        <thead>
        <tr style="background-color: #f2f2f2; border: 1px solid #000;">
            <th style="width: 50%; border: 1px solid #000;">References</th>
            <th style="width: 50%; border: 1px solid #000;">Textbooks</th>
        </tr>
        </thead>
        <tbody>
    ';
    ...
    $html .= '<tr>';
    $html .= '<td style="width: 50%; border: 1px solid #000;">';
